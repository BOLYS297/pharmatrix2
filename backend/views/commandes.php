        ...
        <div class="modal-content">
            ...
            <form id="commandeWizardForm">
                ...
                <div class="modal-body step step-1">
                    ...
                    <div class="mb-3">
                        <label for="clientNom" class="form-label fw-bold">Nom <span class="text-danger">*</span></label>
                        <input
                            type="text"
                            class="form-control"
                            id="clientNom"
                    ...
                    <div class="mb-3">
                        <label for="clientPrenom" class="form-label fw-bold">Prénom <span class="text-danger">*</span></label>
                        <input
                            type="text"
                            class="form-control"
                            id="clientPrenom"
                    ...
                    <div class="mb-3">
                        <label for="clientEmail" class="form-label fw-bold">Email</label>
                    ...
                    <div class="mb-3">
                        <label for="clientTelephone" class="form-label fw-bold">Téléphone <span class="text-danger">*</span></label>
                        <input
                            type="tel"
                            class="form-control"
                            id="clientTelephone"
                ...
                <div class="modal-body step step-2" style="display: none">
                    ...
                    <div class="mb-3">
                        <label for="medicamentId" class="form-label fw-bold">Médicament <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="quantite" class="form-label fw-bold">Quantité <span class="text-danger">*</span></label>
                            <input
                                type="number"
                                class="form-control"
                                id="quantite"
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="prixUnitaire" class="form-label fw-bold">Prix Unitaire (FCFA)</label>
                            <input
                                type="text"
                                class="form-control"
                                id="prixUnitaire"
                    ...
                    <div class="mb-3">
                        <label for="instructions" class="form-label fw-bold">Instructions spéciales</label>
                        <textarea
                            class="form-control"
                            id="instructions"
                            rows="2"></textarea>
                ...
                <div class="modal-body step step-3" style="display: none">
                    ...
                    <div class="confirmation-details">
                        ...
                        <div class="mb-3">
                            <label for="modePaiement" class="form-label fw-bold">Mode de paiement <span class="text-danger">*</span></label>
